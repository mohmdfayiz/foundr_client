          ...
          <div className="md:flex flex-col flex-auto h-full p-6 hidden">
            <div className="flex flex-col flex-auto rounded-2xl bg-gray-100 h-full p-4">
              ...
              <div className="flex flex-col h-full overflow-x-auto scrollbar-hide mb-4">
                <div className="flex flex-col h-full">
                  <div className="grid grid-cols-12 gap-y-2">
                    {message.map((msg) =>
                      msg.myself ? (
                        <div key={msg._id} className="col-start-6 col-end-13 p-3 rounded-lg">
                        ...
                        <div key={msg.message} className="col-start-1 col-end-8 p-3 rounded-lg">
              ...
              <div className="flex flex-row items-center h-16 rounded-xl bg-white w-full px-4">
                ...
                <div className="ml-4">
                  <button onClick={sendmsg} className="flex items-center justify-center bg-darkBlue hover:bg-lightBlue rounded-xl text-white px-4 py-1 flex-shrink-0">
                    <span>Send</span>
                    <span className="ml-2">
                      <svg
